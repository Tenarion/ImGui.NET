...
namespace ImGuiExtraNET
{
    public static unsafe partial class ImGuiExtra
    {
        ...
        public static void DrawRowsBackground(int row_count, float line_height, float x1, float x2, float y_offset, uint col_even, uint col_odd)
        {
            ImGuiExtraNative.ImGuiExtra_DrawRowsBackground(row_count, line_height, x1, x2, y_offset, col_even, col_odd);
        }
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP2_1_OR_GREATER
